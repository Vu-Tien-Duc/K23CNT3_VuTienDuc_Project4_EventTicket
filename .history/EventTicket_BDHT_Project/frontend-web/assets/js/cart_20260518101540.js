...
async function loadCart() {
    ...
    if (!orderId) {
        ...
        cartMessage.innerHTML = `Bạn chưa có giỏ hàng đang xử lý. <a href="${window.pageUtils.resolveUrl('/index.html')}" style="color:#007bff;">Quay lại trang chủ</a> để chọn vé.`;
        return;
    }
