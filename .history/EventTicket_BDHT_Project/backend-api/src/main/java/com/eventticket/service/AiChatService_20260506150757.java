...
public class AiChatService {
     ...
     */
    public G8_AiChatLog saveUserMessage(Integer userId, String sessionCode, String messageText) {
     ...
     */
    public G8_AiChatLog saveAiResponse(Integer userId, String sessionCode, String responseText) {
        G8_AiChatLog chatLog = new G8_AiChatLog();
        chatLog.setUserId(userId);
        chatLog.setSessionCode(sessionCode);
