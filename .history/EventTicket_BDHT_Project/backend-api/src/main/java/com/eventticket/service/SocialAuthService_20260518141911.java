...
public class SocialAuthService {
    ...
    private SocialProfile fetchGoogleProfile(String accessToken) {
        ...
        // or Google issues a token with a different audience.
        // Keep the check only when client-id is configured.
        // If you still see issues, ensure app.oauth.google.client-id matches
        // login.html.
