...
public class MemberAccountController {
    ...
    public ResponseEntity<?> getMe() {
        ...
        G8_users me = userService.getUserById(userId);
    ...
    public ResponseEntity<?> resetPassword(@RequestBody ResetPasswordRequest req) {
        // Nếu project bạn coi “reset” là gửi mail/hoặc đặt mật khẩu mới theo token,
        // có thể map lại theo AuthService. Ở đây dùng UserService reset trực tiếp nếu
        // có.
        Integer userId = currentUserIdOrThrow();
