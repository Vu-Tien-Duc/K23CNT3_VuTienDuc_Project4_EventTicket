...
public interface EventRepository extends JpaRepository<G8_event, Integer> {
    ...
    // THÊM MỚI 2: Lấy Top 8 sự kiện có điểm đánh giá cao nhất (Sử dụng Keyword của
    // JPA)

    List<G8_event> findTop8ByStatusAndDeletedAtIsNullOrderByEventIdDesc(String status);
}
