...
public class SocialAuthService {
    ...
    public SocialAuthService(UserRepository userRepository, PasswordEncoder passwordEncoder, ObjectMapper objectMapper) {
    ...
    private SocialProfile fetchGoogleProfile(String accessToken) {
        ...
        if (googleClientId != null && !googleClientId.isBlank() && !googleClientId.equals(audience)) {
            throw new RuntimeException("Google token khong thuoc ung dung hien tai");
        }
