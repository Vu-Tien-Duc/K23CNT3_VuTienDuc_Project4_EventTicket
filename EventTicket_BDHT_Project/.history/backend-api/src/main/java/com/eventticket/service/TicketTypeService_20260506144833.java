...
public class TicketTypeService {
     ...
     */
    public List<Vtd_G8_ticketType> getActiveTicketTypesByEvent(Integer eventId) {
     ...
     */
    public List<Vtd_G8_ticketType> getAvailableTicketsByEvent(Integer eventId) {
     ...
     */
    public List<Vtd_G8_ticketType> getTicketTypesByEvent(Integer eventId) {
     ...
     */
    public Vtd_G8_ticketType createTicketType(Vtd_G8_ticketType ticketType) {
     ...
     */
    public Vtd_G8_ticketType updateTicketType(Integer ticketTypeId, Vtd_G8_ticketType ticketTypeDetails) {
