...
@RestController
@RequestMapping("/api/lpth/admin/reviews")
...
public class AdminReviewController {
     ...
     * URL ví dụ:
     * - Lấy tất cả: GET /api/lpth/admin/reviews
     * - Xem đánh giá của sự kiện 1: GET /api/lpth/admin/reviews?eventId=1
     * - Xem các đánh giá ĐANG BỊ ẨN (vi phạm): GET /api/lpth/admin/reviews?isHidden=true
     */
    @GetMapping
     ...
     * URL: GET /api/lpth/admin/reviews/user/5
     */
     ...
     * URL: PUT /api/lpth/admin/reviews/10/hide
     */
    @PutMapping("/{id}/hide")
     ...
     * URL: PUT /api/lpth/admin/reviews/10/show
     */
    @PutMapping("/{id}/show")
     ...
     * URL: DELETE /api/lpth/admin/reviews/10
     */
    @DeleteMapping("/{id}")
     ...
     * URL: GET /api/lpth/admin/reviews/stats/event/1
     */
