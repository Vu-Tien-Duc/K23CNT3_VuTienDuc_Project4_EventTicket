...
import com.eventticket.service.admin.TtbAdminVenueService; // Hoặc VenueService tùy bạn đặt tên
...
@RestController
@RequestMapping("/api/ttb/admin/venues")
@RequiredArgsConstructor
public class TtbAdminVenueController {

    private final TtbAdminVenueService adminVenueService;

    /**
     * API: Lấy danh sách kết hợp tìm kiếm và lọc
     * URL ví dụ:
     * - Lấy tất cả: GET /api/ttb/admin/venues
     * - Tìm theo tên: GET /api/ttb/admin/venues?keyword=Hà Nội
     * - Lọc sức chứa: GET /api/ttb/admin/venues?minCapacity=500&maxCapacity=2000
     * - Kết hợp: GET /api/ttb
     * /admin/venues?keyword=Sân&minCapacity=1000
     */
    @GetMapping
    public ResponseEntity<List<G8_venue>> getAll(
        ...
        // Gọi hàm tìm kiếm động từ Service (Nếu tất cả param là null, nó sẽ tự động trả
