...
import com.eventticket.service.admin.TtbAdminTicketService;
...
@RestController
@RequestMapping("/api/ttb/admin/tickets")
@RequiredArgsConstructor
public class TtbAdminTicketController {

    private final TtbAdminTicketService adminTicketService;
    ...
    // Tính năng #74: Tìm kiếm vé theo mã QR Code (Dùng để hiển thị thông tin vé
    // trước khi check-in)
     ...
     * URL: POST /api/ttb/admin/tickets/process-checkin/{qrCode}
     */
