...
@RestController
@RequestMapping("/api/lpth/admin/users")
...
public class TtbAdminUserController {
    ...
    // API: GET /api/lpth/admin/users/{id}
    @GetMapping("/{id}")
    ...
    // API: POST /api/lpth/admin/users/add
    @PostMapping("/add")
    ...
    // API: PUT /api/lpth/admin/users/block/{id}
    @PutMapping("/block/{id}")
    ...
    // API: PUT /api/lpth/admin/users/unblock/{id}
    ...
    // API: DELETE /api/lpth/admin/users/delete/{id}
    ...
    // API: GET /api/lpth/admin/users/active
    @GetMapping("/active")
    ...
    // API: GET /api/lpth/admin/users/count-admins
