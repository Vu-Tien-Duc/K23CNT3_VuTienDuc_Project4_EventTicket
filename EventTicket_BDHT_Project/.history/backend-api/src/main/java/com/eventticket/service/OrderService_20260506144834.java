...
public class OrderService {
     ...
     */
    @Transactional
    public Vtd_G8_order createOrder(Integer userId) {
        Vtd_G8_order order = new Vtd_G8_order();
     ...
     */
    @Transactional
    public VtdG8OrderItem addTicketTypeToOrder(Integer orderId, Integer ticketTypeId, Integer quantity) {
        Vtd_G8_order order = orderRepository.findById(orderId)
        ...
        VtdG8OrderItem orderItem = new VtdG8OrderItem();
     ...
     */
    @Transactional
    public VtdG8OrderItem updateOrderItemQuantity(Integer orderItemId, Integer newQuantity) {
        VtdG8OrderItem orderItem = orderItemRepository.findById(orderItemId)
        ...
        Vtd_G8_order order = orderItem.getOrder();
     ...
     */
    public Vtd_G8_order applyPromotionToOrder(Integer orderId, String promotionCode) {
        Vtd_G8_order order = orderRepository.findById(orderId)
                .orElseThrow(() -> new RuntimeException("Đơn hàng không tồn tại"));
        
        Vtd_G8_promotion promo = promotionService.validateAndApplyPromotion(promotionCode);
     ...
     */
    public Vtd_G8_order removePromotionFromOrder(Integer orderId) {
        Vtd_G8_order order = orderRepository.findById(orderId)
                .orElseThrow(() -> new RuntimeException("Đơn hàng không tồn tại"));
     ...
     */
    public List<Vtd_G8_order> getUserOrders(Integer userId) {
     ...
     */
    public List<Vtd_G8_order> getUserOrdersByStatus(Integer userId, String status) {
     ...
     */
    public Vtd_G8_order getOrderDetails(Integer orderId) {
     ...
     */
    public List<Vtd_G8_order> getAllOrders() {
     ...
     */
    public List<Vtd_G8_order> getOrdersByStatus(String status) {
     ...
     */
    public Vtd_G8_order updateOrderStatus(Integer orderId, String status) {
        Vtd_G8_order order = orderRepository.findById(orderId)
                .orElseThrow(() -> new RuntimeException("Đơn hàng không tồn tại"));
     ...
     */
    private BigDecimal calculateDiscount(BigDecimal totalAmount, Vtd_G8_promotion promo) {
