...
public class TtbAdminTicketService {
    ...
    public G8_ticket processCheckInLogic(String qrCode) {
        ...
        if (ticket.getOrder() == null || !"COMPLETED".equals(ticket.getOrder().getStatus())) {
            throw new RuntimeException("TU CHOI CAP PHEP: Ve khong con hieu luc do don hang da bi huy hoac hoan tien.");
        }
